...
STATUS_BOLSA      = [True, False]
STATUS_CAMPANHA   = [True, False]
...
def deletar_bolsa(id):
    ...
    for bolsa in dados['bolsas']:
        if bolsa.get('id') == id:
            ...
            salvar_dados(dados)
            return jsonify({"mensagem": "Bolsa removida com sucesso!"}), 204
...
def deletar_paciente(id):
    ...
    for paciente in dados['pacientes']:
        if paciente.get('id') == id:
            ...
            salvar_dados(dados)
            return jsonify({"mensagem": "Paciente removido com sucesso!"}), 204
...
def deletar_doacao(id):
    ...
    for doacao in dados['doacoes']:
        if doacao.get('id') == id:
            ...
            salvar_dados(dados)
            return jsonify({"mensagem": "Doação removida com sucesso!"}), 204
...
def deletar_centro(id):
    ...
    for centro in dados['centros']:
        if centro.get('id') == id:
            ...
            salvar_dados(dados)
            return jsonify({"mensagem": "Centro removido com sucesso!"}), 204
...
def deletar_campanha(id):
    ...
    for campanha in dados['campanhas']:
        if campanha.get('id') == id:
            ...
            salvar_dados(dados)
            return jsonify({"mensagem": "Campanha removida com sucesso!"}), 204
